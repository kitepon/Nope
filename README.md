...
**v2.0.1 is live on the Chrome Web Store.** Install from the [Chrome Web Store](https://chromewebstore.google.com/detail/bodffbgmcokkhlibiehhelefknmbiaaf). The public source and this README are available now.
